...
function Container3() {
  return (
    <div className="absolute content-stretch flex gap-[11.997px] h-[35.992px] items-center left-[48.86px] top-[126.51px] w-[283.976px]" data-name="Container">
      <PrimitiveButton />
      <PrimitiveButton1 />
    </div>
  );
...
function Container4() {
  return (
    <div className="absolute h-[162.497px] left-0 top-0 w-[48.86px]" data-name="Container">
      <Heading />
      <Paragraph />
    </div>
  );
...
function Container1() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[188.652px] items-start left-0 pb-[1.162px] pt-[23.994px] px-[44.994px] top-0 w-[422.824px]" data-name="Container">
...
function Container7() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.986px] h-[186.02px] items-start left-0 pl-[23.468px] top-0 w-[71.711px]" data-name="Container">
...
function Paragraph4() {
  return (
    <div className="h-[58.479px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[19.5px] left-0 text-[#666] text-[13px] top-[-2px] tracking-[0.325px] uppercase w-[47px] whitespace-pre-wrap">Biến động 7 ngày</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[77.973px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[19.5px] left-0 text-[#666] text-[13px] top-[-2px] w-[49px] whitespace-pre-wrap">↑ 1,800₫ so với tuần trước</p>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.986px] h-[186.02px] items-start left-[95.71px] pl-[23.468px] top-0 w-[71.711px]" data-name="Container">
...
function Icon3() {
  return (
    <div className="absolute h-[19.983px] left-[46.48px] top-[12.54px] w-[1.761px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.76056 19.9832">
        <g clipPath="url(#clip0_124_1929)" id="Icon">
          <path d={svgPaths.p32b15000} id="Vector" stroke="var(--stroke-0, #F54900)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.146713" />
          <path d={svgPaths.p1d785f80} id="Vector_2" stroke="var(--stroke-0, #F54900)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.146713" />
        </g>
        <defs>
          <clipPath id="clip0_124_1929">
            <rect fill="white" height="19.9832" width="1.76056" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function Container11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.986px] h-[186.02px] items-start left-[191.41px] pl-[23.468px] top-0 w-[71.711px]" data-name="Container">
...
function Icon4() {
  return (
    <div className="absolute h-[19.983px] left-[32px] top-[12.54px] w-[16.244px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.2443 19.9832">
        <g id="Icon">
          <path d={svgPaths.p349d4cf0} id="Vector" stroke="var(--stroke-0, #E7000B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.35369" />
          <path d="M8.12215 7.96107V10.6685" id="Vector_2" stroke="var(--stroke-0, #E7000B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.35369" />
          <path d="M8.12215 13.3758H8.12892" id="Vector_3" stroke="var(--stroke-0, #E7000B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.35369" />
        </g>
      </svg>
    </div>
  );
...
function Paragraph12() {
  return (
    <div className="h-[38.986px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[19.5px] left-0 text-[#666] text-[13px] top-[-2px] w-[45px] whitespace-pre-wrap">Tăng trên 5%</p>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.986px] h-[186.02px] items-start left-[287.12px] pl-[23.468px] top-0 w-[71.711px]" data-name="Container">
...
function Container6() {
  return (
    <div className="h-[186.02px] relative shrink-0 w-full" data-name="Container">
      <Container7 />
      <Container9 />
      <Container11 />
      <Container13 />
...
function Container5() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[251.179px] items-start left-0 pb-[1.162px] pt-[31.999px] px-[31.999px] top-[188.65px] w-[422.824px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b-[1.162px] border-solid inset-0 pointer-events-none" />
      <Container6 />
    </div>
  );
...
function Container17() {
  return (
    <div className="content-stretch flex h-[217.002px] items-center justify-between pr-[-33.559px] relative shrink-0 w-full" data-name="Container">
      <Container18 />
      <Container19 />
    </div>
  );
...
function Group1() {
  return (
    <div className="absolute inset-[3.36%_5.52%_13.35%_33.15%]" data-name="Group">
      <div className="absolute inset-[-0.2%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 110.94 250.864">
          <g id="Group">
            <path d="M0 250.364H110.94" id="Vector" stroke="var(--stroke-0, #E5E5E5)" strokeDasharray="3 3" strokeWidth="0.999457" />
            <path d="M0 187.898H110.94" id="Vector_2" stroke="var(--stroke-0, #E5E5E5)" strokeDasharray="3 3" strokeWidth="0.999457" />
            <path d="M0 125.432H110.94" id="Vector_3" stroke="var(--stroke-0, #E5E5E5)" strokeDasharray="3 3" strokeWidth="0.999457" />
            <path d="M0 62.9658H110.94" id="Vector_4" stroke="var(--stroke-0, #E5E5E5)" strokeDasharray="3 3" strokeWidth="0.999457" />
            <path d="M0 0.499728H110.94" id="Vector_5" stroke="var(--stroke-0, #E5E5E5)" strokeDasharray="3 3" strokeWidth="0.999457" />
          </g>
        </svg>
      </div>
    </div>
...
function Group() {
  return (
    <div className="absolute contents inset-[3.36%_5.52%_13.35%_33.15%]" data-name="Group">
      <Group1 />
    </div>
  );
}
...
function Group4() {
  return (
    <div className="absolute contents inset-[86.65%_59.66%_7.42%_24.86%]" data-name="Group">
      <div className="absolute inset-[86.65%_66.85%_11.35%_33.15%]" data-name="Vector">
        <div className="absolute inset-[0_-0.5px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.999457 5.99674">
            <path d="M0.499728 5.99674V0" id="Vector" stroke="var(--stroke-0, #E5E5E5)" strokeWidth="0.999457" />
          </svg>
        </div>
      </div>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[88.25%_59.66%_7.42%_24.86%] leading-[normal] not-italic text-[#999] text-[10.994px] text-center">01/01</p>
    </div>
  );
}
...
function Group5() {
  return (
    <div className="absolute contents inset-[86.65%_-0.57%_7.42%_82.88%]" data-name="Group">
      <div className="absolute inset-[86.65%_5.52%_11.35%_94.48%]" data-name="Vector">
        <div className="absolute inset-[0_-0.5px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.999457 5.99674">
            <path d="M0.499728 5.99674V0" id="Vector" stroke="var(--stroke-0, #E5E5E5)" strokeWidth="0.999457" />
          </svg>
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[88.25%_-0.57%_7.42%_82.88%] leading-[normal] not-italic text-[#999] text-[10.994px] text-center">03/02</p>
    </div>
  );
}
...
function Group3() {
  return (
    <div className="absolute contents inset-[86.65%_-0.57%_7.42%_24.86%]" data-name="Group">
      <Group4 />
      <Group5 />
    </div>
  );
...
function Group2() {
  return (
    <div className="absolute contents inset-[86.65%_-0.57%_7.42%_24.86%]" data-name="Group">
      <div className="absolute inset-[86.65%_5.52%_13.35%_33.15%]" data-name="Vector">
        <div className="absolute inset-[-0.5px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 110.94 0.999457">
            <path d="M0 0.499728H110.94" id="Vector" stroke="var(--stroke-0, #E5E5E5)" strokeWidth="0.999457" />
          </svg>
        </div>
      </div>
      <Group3 />
...
function Group8() {
  return (
    <div className="absolute contents inset-[84.28%_66.85%_11.38%_16.57%]" data-name="Group">
      <div className="absolute inset-[86.65%_66.85%_13.35%_29.83%]" data-name="Vector">
        <div className="absolute inset-[-0.5px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.99674 0.999457">
            <path d="M0 0.499728H5.99674" id="Vector" stroke="var(--stroke-0, #E5E5E5)" strokeWidth="0.999457" />
          </svg>
        </div>
      </div>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[84.28%_71.82%_11.38%_16.57%] leading-[normal] not-italic text-[#999] text-[10.994px] text-right">20K</p>
    </div>
  );
}
...
function Group9() {
  return (
    <div className="absolute contents inset-[63.46%_66.85%_32.2%_16.57%]" data-name="Group">
      <div className="absolute inset-[65.83%_66.85%_34.17%_29.83%]" data-name="Vector">
        <div className="absolute inset-[-0.5px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.99674 0.999457">
            <path d="M0 0.499728H5.99674" id="Vector" stroke="var(--stroke-0, #E5E5E5)" strokeWidth="0.999457" />
          </svg>
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[63.46%_71.82%_32.2%_16.57%] leading-[normal] not-italic text-[#999] text-[10.994px] text-right">22K</p>
    </div>
  );
}
...
function Group10() {
  return (
    <div className="absolute contents inset-[42.64%_66.85%_53.03%_16.57%]" data-name="Group">
      <div className="absolute inset-[45%_66.85%_55%_29.83%]" data-name="Vector">
        <div className="absolute inset-[-0.5px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.99674 0.999457">
            <path d="M0 0.499728H5.99674" id="Vector" stroke="var(--stroke-0, #E5E5E5)" strokeWidth="0.999457" />
          </svg>
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[42.64%_71.82%_53.03%_16.57%] leading-[normal] not-italic text-[#999] text-[10.994px] text-right">23K</p>
    </div>
  );
}
...
function Group11() {
  return (
    <div className="absolute contents inset-[21.82%_66.85%_73.85%_16.57%]" data-name="Group">
      <div className="absolute inset-[24.18%_66.85%_75.82%_29.83%]" data-name="Vector">
        <div className="absolute inset-[-0.5px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.99674 0.999457">
            <path d="M0 0.499728H5.99674" id="Vector" stroke="var(--stroke-0, #E5E5E5)" strokeWidth="0.999457" />
          </svg>
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[21.82%_71.82%_73.85%_16.57%] leading-[normal] not-italic text-[#999] text-[10.994px] text-right">25K</p>
    </div>
  );
}
...
function Group12() {
  return (
    <div className="absolute contents inset-[0.99%_66.85%_94.67%_16.57%]" data-name="Group">
      <div className="absolute inset-[3.36%_66.85%_96.64%_29.83%]" data-name="Vector">
        <div className="absolute inset-[-0.5px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.99674 0.999457">
            <path d="M0 0.499728H5.99674" id="Vector" stroke="var(--stroke-0, #E5E5E5)" strokeWidth="0.999457" />
          </svg>
      ...
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[0.99%_71.82%_94.67%_16.57%] leading-[normal] not-italic text-[#999] text-[10.994px] text-right">26K</p>
    </div>
  );
}
...
function Group7() {
  return (
    <div className="absolute contents inset-[0.99%_66.85%_11.38%_16.57%]" data-name="Group">
      <Group8 />
      <Group9 />
      <Group10 />
      <Group11 />
...
function Group6() {
  return (
    <div className="absolute contents inset-[0.99%_66.85%_11.38%_16.57%]" data-name="Group">
      <div className="absolute inset-[3.36%_66.85%_13.35%_33.15%]" data-name="Vector">
        <div className="absolute inset-[0_-0.5px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 0.999457 249.864">
            <path d="M0.499728 0V249.864" id="Vector" stroke="var(--stroke-0, #E5E5E5)" strokeWidth="0.999457" />
          </svg>
        </div>
      </div>
      <Group7 />
...
function Group16() {
  return (
    <div className="absolute inset-[13.07%_5.52%_13.35%_33.15%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_-39.146px] mask-size-[110.94px_261.858px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <div className="absolute inset-[-0.41%_-0.77%_0_-1.04%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 112.948 221.628">
          <g id="Group">
            <path d={svgPaths.p19c2a770} fill="url(#paint0_linear_124_1840)" fillOpacity="0.6" id="Vector" />
            <path d={svgPaths.p3b4e4b00} id="Vector_2" stroke="var(--stroke-0, #2563EB)" strokeWidth="2.49864" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_124_1840" x1="1.15849" x2="1.15849" y1="0.915465" y2="221.628">
...
function Group15() {
  return (
    <div className="absolute contents inset-[13.07%_5.52%_13.35%_33.15%]" data-name="Group">
      <Group16 />
    </div>
  );
}
...
function ClipPathGroup() {
  return (
    <div className="absolute contents inset-[0.02%_5.52%_12.68%_33.15%]" data-name="Clip path group">
      <Group15 />
    </div>
  );
}
...
function Group14() {
  return (
    <div className="absolute contents inset-[0.02%_5.52%_12.68%_33.15%]" data-name="Group">
      <ClipPathGroup />
    </div>
  );
}
...
function Group17() {
  return (
    <div className="absolute inset-[13.77%_5.52%_30.01%_44.3%]" data-name="Group">
      <div className="absolute inset-[-0.21%_-0.73%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 92.0888 169.369">
          <g id="Group">
            <path d={svgPaths.p2d815740} id="Vector" stroke="var(--stroke-0, #9333EA)" strokeDasharray="5 5 5 5 5 5 5 5" strokeWidth="1.49918" />
          </g>
        </svg>
      </div>
    </div>
...
function Group18() {
  return (
    <div className="absolute inset-[33.9%_5.52%_39.03%_70.32%]" data-name="Group">
      <div className="absolute inset-[-0.44%_-1.51%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 45.0235 81.9162">
          <g id="Group">
            <path d={svgPaths.p2c78e280} id="Vector" stroke="var(--stroke-0, #F97316)" strokeDasharray="3 3 3 3 3 3 3 3" strokeWidth="1.49918" />
          </g>
        </svg>
      </div>
    </div>
...
function Surface() {
  return (
    <div className="absolute h-[299.984px] left-0 overflow-clip top-0 w-[180.902px]" data-name="Surface">
      <Group />
      <Group2 />
      <Group6 />
      <Group13 />
...
function Group22() {
  return (
    <div className="absolute inset-[25.15%_5.52%_0.02%_5.52%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_-15.075px] mask-size-[160.913px_60.967px]" data-name="Group" style={{ maskImage: `url('${imgGroup1}')` }}>
      <div className="absolute inset-[-0.97%_-0.15%_0_-0.17%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 161.433 45.3279">
          <g id="Group">
            <path d={svgPaths.p3f26a2a0} fill="url(#paint0_linear_124_1940)" fillOpacity="0.6" id="Vector" />
            <path d={svgPaths.p3058e240} id="Vector_2" stroke="var(--stroke-0, #64748B)" strokeWidth="0.999457" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_124_1940" x1="0.274527" x2="0.274527" y1="0.435279" y2="45.3279">
...
function Group21() {
  return (
    <div className="absolute contents inset-[25.15%_5.52%_0.02%_5.52%]" data-name="Group">
      <Group22 />
    </div>
  );
}
...
function ClipPathGroup1() {
  return (
    <div className="absolute contents inset-[0.02%_5.52%_-1.65%_5.52%]" data-name="Clip path group">
      <Group21 />
    </div>
  );
}
...
function Group20() {
  return (
    <div className="absolute contents inset-[0.02%_5.52%_-1.65%_5.52%]" data-name="Group">
      <ClipPathGroup1 />
    </div>
  );
}
...
function Surface1() {
  return (
    <div className="absolute h-[59.986px] left-0 overflow-clip top-0 w-[180.902px]" data-name="Surface">
      <Group19 />
    </div>
  );
}
...
function Container16() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[23.994px] h-[817.824px] items-start left-0 pb-[1.162px] pt-[25.156px] px-[25.156px] rounded-[4px] top-0 w-[231.214px]" data-name="Container">
...
function Heading2() {
  return (
    <div className="h-[120.063px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#1a1a1a] text-[16px] top-[-1.84px] w-[52px] whitespace-pre-wrap">Bản đồ nhiệt biến động giá</p>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="absolute left-0 opacity-40 size-[53.289px] top-0" data-name="Container">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute left-0 max-w-none size-[375.31%] top-0" src={imgContainer} />
      </div>
    </div>
  );
}
...
function Container28() {
  return (
    <div className="absolute h-[127.45px] left-[-53.18px] top-[-37.08px] w-[159.666px]" data-name="Container">
      <Icon5 />
      <Paragraph14 />
      <Container29 />
    </div>
...
function Container26() {
  return (
    <div className="h-[53.289px] overflow-clip relative rounded-[4px] shrink-0 w-full" data-name="Container" style={{ backgroundImage: "linear-gradient(135deg, rgb(249, 250, 251) 0%, rgb(243, 244, 246) 100%)" }}>
      <Container27 />
      <Container28 />
    </div>
  );
...
function Container25() {
  return (
    <div className="bg-white h-[239.653px] relative rounded-[4px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[1.162px] border-solid inset-0 pointer-events-none rounded-[4px]" />
...
function Heading3() {
  return (
    <div className="h-[62.944px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[21px] left-0 text-[#1a1a1a] text-[14px] top-[-0.84px] w-[47px] whitespace-pre-wrap">Nhận định tự động</p>
    </div>
  );
}
...
function Paragraph15() {
  return (
    <div className="h-[443.279px] relative shrink-0 w-full" data-name="Paragraph">
...
function Container36() {
  return (
    <div className="bg-[#eff6ff] h-[554.176px] relative rounded-br-[4px] rounded-tr-[4px] shrink-0 w-full" data-name="Container">
...
function Container24() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[23.994px] h-[817.824px] items-start left-[255.21px] top-0 w-[103.601px]" data-name="Container">
      <Container25 />
      <Container36 />
    </div>
  );
...
function Container15() {
  return (
    <div className="absolute h-[817.824px] left-[32px] top-[471.83px] w-[358.827px]" data-name="Container">
      <Container16 />
      <Container24 />
    </div>
  );
...
function Paragraph16() {
  return (
    <div className="h-[38.986px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[19.5px] left-0 text-[#666] text-[13px] top-[-2px] w-[299px] whitespace-pre-wrap">Tỉnh/thành phố có biến động giá vượt ngưỡng cảnh báo</p>
    </div>
  );
}
...
function Container42() {
  return <div className="bg-[#e7000b] h-[47.989px] rounded-[38977000px] shrink-0 w-[3.993px]" data-name="Container" />;
}

function Paragraph17() {
  return (
    <div className="h-[67.464px] relative shrink-0 w-full" data-name="Paragraph">
...
function Paragraph18() {
  return (
    <div className="h-[35.973px] relative shrink-0 w-full" data-name="Paragraph">
...
function Container44() {
  return (
    <div className="absolute content-stretch flex flex-col h-[103.437px] items-start left-0 top-[0.65px] w-[52.127px]" data-name="Container">
      <Paragraph17 />
      <Paragraph18 />
    </div>
  );
...
function Container45() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[1.996px] h-[84.489px] items-start left-[76.12px] top-[10.13px] w-[26.753px]" data-name="Container">
      <Paragraph19 />
      <Paragraph20 />
    </div>
  );
...
function Container46() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[1.996px] h-[64.995px] items-start left-[126.87px] top-[19.87px] w-[26.771px]" data-name="Container">
      <Paragraph21 />
      <Paragraph22 />
    </div>
  );
...
function Text6() {
  return (
    <div className="bg-[#ffe2e2] h-[61.946px] relative rounded-[4px] shrink-0 w-full" data-name="Text">
...
function Container47() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[3.812px] h-[104.744px] items-start left-[177.63px] top-0 w-[52.127px]" data-name="Container">
      <Paragraph23 />
      <Text6 />
    </div>
  );
...
function Button() {
  return (
    <div className="absolute h-[31.999px] left-[253.76px] rounded-[8px] top-[36.37px] w-[109.173px]" data-name="Button">
...
function Container41() {
  return (
    <div className="h-[104.744px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[23.994px] items-center relative size-full">
          <Container42 />
          <Container43 />
        </div>
      </div>
...
function Container40() {
  return (
    <div className="absolute content-stretch flex flex-col h-[137.886px] items-start left-0 pb-[1.162px] pt-[15.99px] px-[23.994px] top-0 w-[356.504px]" data-name="Container">
...
function Container50() {
  return <div className="bg-[#f54900] h-[47.989px] rounded-[38977000px] shrink-0 w-[3.993px]" data-name="Container" />;
}

function Paragraph24() {
  return (
    <div className="absolute h-[44.976px] left-0 top-0 w-[52.127px]" data-name="Paragraph">
...
function Paragraph25() {
  return (
    <div className="absolute h-[71.947px] left-0 top-[44.98px] w-[52.127px]" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[18px] left-0 text-[#999] text-[12px] top-[-2px] w-[51px] whitespace-pre-wrap">Đồng bằng sông Cửu Long</p>
    </div>
  );
}
...
function Container52() {
  return (
    <div className="absolute h-[116.923px] left-0 top-0 w-[52.127px]" data-name="Container">
      <Paragraph24 />
      <Paragraph25 />
    </div>
  );
...
function Container53() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[1.996px] h-[84.489px] items-start left-[76.12px] top-[16.21px] w-[26.753px]" data-name="Container">
      <Paragraph26 />
      <Paragraph27 />
    </div>
  );
...
function Container54() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[1.996px] h-[64.995px] items-start left-[126.87px] top-[25.95px] w-[26.771px]" data-name="Container">
      <Paragraph28 />
      <Paragraph29 />
    </div>
  );
...
function Text7() {
  return (
    <div className="bg-[#ffedd4] h-[43.959px] relative rounded-[4px] shrink-0 w-full" data-name="Text">
...
function Container55() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[3.812px] h-[86.757px] items-start left-[177.63px] top-[15.08px] w-[52.127px]" data-name="Container">
      <Paragraph30 />
      <Text7 />
    </div>
  );
...
function Button1() {
  return (
    <div className="absolute h-[31.999px] left-[253.76px] rounded-[8px] top-[42.45px] w-[109.173px]" data-name="Button">
      <p className="-translate-x-1/2 absolute font-['Arimo:Regular',sans-serif] font-normal leading-[19.5px] left-[55.5px] text-[#155dfc] text-[13px] text-center top-[4.24px]">Xem chi tiết →</p>
    </div>
  );
}
...
function Container51() {
  return (
    <div className="flex-[1_0_0] h-[116.923px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container52 />
        <Container53 />
        <Container54 />
...
function Container49() {
  return (
    <div className="h-[116.923px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[23.994px] items-center relative size-full">
          <Container50 />
          <Container51 />
...
function Container48() {
  return (
    <div className="absolute content-stretch flex flex-col h-[150.065px] items-start left-0 pb-[1.162px] pt-[15.99px] px-[23.994px] top-[137.89px] w-[356.504px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#f3f4f6] border-b-[1.162px] border-solid inset-0 pointer-events-none" />
      <Container49 />
    </div>
  );
...
function Container56() {
  return (
    <div className="absolute content-stretch flex gap-[23.994px] h-[116.923px] items-center left-[23.99px] top-[303.94px] w-[308.515px]" data-name="Container">
      <Container57 />
      <Container58 />
    </div>
  );
...
function Container39() {
  return (
    <div className="h-[436.854px] relative shrink-0 w-full" data-name="Container">
      <Container40 />
      <Container48 />
      <Container56 />
    </div>
...
function Container37() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[550.292px] items-start left-[32px] pb-[1.162px] pt-[1.161px] px-[1.162px] rounded-[4px] top-[1321.65px] w-[358.827px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[1.162px] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Container38 />
      <Container39 />
    </div>
...
function Button3() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[11.997px] h-[363.655px] items-start left-0 pb-[1.162px] pt-[24.14px] px-[21.145px] rounded-[4px] top-0 w-[58.97px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[1.162px] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Container65 />
      <Heading6 />
      <Paragraph38 />
...
function Button4() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[11.997px] h-[363.655px] items-start left-[74.96px] pb-[1.162px] pt-[22.633px] px-[21.145px] rounded-[4px] top-0 w-[58.97px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[1.162px] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Container66 />
      <Heading7 />
      <Paragraph39 />
...
function Button5() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[11.997px] h-[363.655px] items-start left-[149.92px] pb-[1.162px] pt-[51.873px] px-[21.145px] rounded-[4px] top-0 w-[58.97px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[1.162px] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Container67 />
      <Heading8 />
      <Paragraph40 />
...
function Button6() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[11.997px] h-[363.655px] items-start left-[224.88px] pb-[1.162px] pt-[51.873px] px-[21.145px] rounded-[4px] top-0 w-[58.97px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[1.162px] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Container68 />
      <Heading9 />
      <Paragraph41 />
...
function Button7() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[11.997px] h-[363.655px] items-start left-[299.84px] pb-[1.162px] pt-[21.145px] px-[21.145px] rounded-[4px] top-0 w-[58.97px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[1.162px] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Container69 />
      <Heading10 />
      <Paragraph42 />
...
function Container63() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15.99px] h-[438.651px] items-start left-0 px-[31.999px] top-[1895.94px] w-[422.824px]" data-name="Container">
      <Heading5 />
      <Container64 />
    </div>
  );
...
function Container() {
  return (
    <div className="bg-[#fafafa] flex-[1_0_0] h-[2334.588px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container1 />
        <Container5 />
        <Container15 />
...
function Pq() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex h-[2390.581px] items-start pt-[55.993px] relative shrink-0 w-full" data-name="pq">
      <Container />
    </div>
  );
}
...
function Button8() {
  return (
    <div className="absolute bg-[#155dfc] content-stretch flex flex-col items-start left-[362.86px] pt-[11.997px] px-[11.997px] rounded-[38977000px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] size-[43.978px] top-[15.99px]" data-name="Button">
      <Icon6 />
    </div>
  );
}
...
function Heading11() {
  return (
    <div className="absolute h-[22.488px] left-[172.79px] overflow-clip top-[16.15px] w-[77.247px]" data-name="Heading 1">
...
function Container74() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[3.993px] h-[39.966px] items-start left-[15.99px] px-[7.986px] top-[23.99px] w-[246.841px]" data-name="Container">
      <Heading12 />
      <Paragraph43 />
    </div>
  );
...
function Container75() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.986px] h-[505.606px] items-start left-[15.99px] top-[87.96px] w-[246.841px]" data-name="Container">
      <Button11 />
      <Button12 />
      <Button13 />
      <Button14 />
...
function Button17() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[226.88px] pt-[7.986px] px-[7.986px] rounded-[38977000px] size-[35.955px] top-[15.99px]" data-name="Button">
      <Icon15 />
    </div>
  );
}
...
function Container73() {
  return (
    <div className="absolute bg-white border-[#e5e7eb] border-r-[1.162px] border-solid h-[895.996px] left-[-279.98px] overflow-clip top-[59.99px] w-[279.983px]" data-name="Container">
      <Container74 />
      <Container75 />
      <Button17 />
    </div>

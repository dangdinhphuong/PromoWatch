import svgPaths from "./svg-ydczfk9bqi";
...
function Button() {
  return (
    <div className="h-[32px] relative rounded-[8px] shrink-0 w-[160.406px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon />
        <p className="-translate-x-1/2 absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[92px] text-[#666] text-[14px] text-center top-[4px]">Quay lại trang chủ</p>
      </div>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="h-[42px] relative shrink-0 w-full" data-name="Heading 1">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[42px] left-0 text-[#1a1a1a] text-[28px] top-[-3px] tracking-[-0.7px]">Kiểm soát hành vi vi phạm trên TMĐT / nền tảng số</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[22.5px] left-0 text-[#666] text-[15px] top-[-1px]">Trung tâm điều hành giám sát – phát hiện và xử lý vi phạm tập trung</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="h-[112.5px] relative shrink-0 w-[621.016px]" data-name="Container">
...
function PrimitiveSpan() {
  return (
    <div className="h-[20px] relative shrink-0 w-[42.391px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#0a0a0a] text-[14px] text-center">7 ngày</p>
      </div>
    </div>
  );
}
...
function PrimitiveSpan1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[98.281px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#0a0a0a] text-[14px] text-center">Tất cả nền tảng</p>
      </div>
    </div>
  );
}
...
function PrimitiveButton1() {
  return (
    <div className="bg-white flex-[1_0_0] h-[36px] min-h-px min-w-px relative rounded-[8px]" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[8px]" />
...
function Container4() {
  return (
    <div className="h-[36px] relative shrink-0 w-[312px]" data-name="Container">
...
function Container1() {
  return (
    <div className="content-stretch flex h-[112.5px] items-end justify-between relative shrink-0 w-full" data-name="Container">
      <Container2 />
      <Container4 />
    </div>
  );
...
function Container() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[161.5px] items-start left-0 pb-px pt-[24px] px-[38.5px] top-0 w-[1613px]" data-name="Container">
...
function Icon4() {
  return (
    <div className="absolute left-[71.28px] size-[20px] top-[13px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p35be1800} id="Vector" stroke="var(--stroke-0, #E7000B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
...
function Icon5() {
  return (
    <div className="absolute left-[52.08px] size-[20px] top-[13px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.p1d27a00} id="Vector" stroke="var(--stroke-0, #F54900)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container5() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[152px] items-start left-0 pb-px pt-[32px] px-[38.5px] top-[161.5px] w-[1613px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-solid inset-0 pointer-events-none" />
      <Container6 />
    </div>
  );
...
function Container15() {
  return (
    <div className="absolute h-[464.5px] left-[38.5px] top-[345.5px] w-[1536px]" data-name="Container">
      <Container16 />
      <Container19 />
    </div>
  );
...
function Container39() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[335.5px] items-start left-[38.5px] p-px rounded-[4px] top-[842px] w-[1536px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Container40 />
      <Container41 />
    </div>
...
function Container65() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[234.5px] items-start left-[6.5px] px-[32px] top-[1201.5px] w-[1600px]" data-name="Container">
      <Heading5 />
      <Container66 />
    </div>
  );
...
function PY() {
  return (
    <div className="absolute bg-[#fafafa] h-[1436px] left-0 top-0 w-[1613px]" data-name="pY">
      <Container />
      <Container5 />
      <Container15 />
      <Container39 />
...
function Text10() {
  return (
    <div className="absolute content-stretch flex h-[16.5px] items-start left-0 top-[-20000px] w-[18.25px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[16.5px] relative shrink-0 text-[#0a0a0a] text-[11px]">20K</p>
    </div>
  );
}

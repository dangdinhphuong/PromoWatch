import svgPaths from "./svg-5fdpxdj291";
import { imgGroup } from "./svg-h35qf";
...
function Button2() {
  return (
    <div className="absolute bg-[#155dfc] content-stretch flex flex-col h-[40px] items-start left-0 pt-[10px] px-[24px] rounded-[10px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)] top-0 w-[133.813px]" data-name="Button">
      <Paragraph2 />
    </div>
  );
}
...
function Group() {
  return (
    <div className="absolute inset-[8.33%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-1.333px_-1.333px] mask-size-[16px_16px]" data-name="Group" style={{ maskImage: `url('${imgGroup}')` }}>
      <div className="absolute inset-[-5%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.6667 14.6667">
          <g id="Group">
            <path d={svgPaths.p29e83a00} id="Vector" stroke="var(--stroke-0, #4A5565)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d={svgPaths.p1cb44d00} id="Vector_2" stroke="var(--stroke-0, #4A5565)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
            <path d="M0.666665 7.33333H14" id="Vector_3" stroke="var(--stroke-0, #4A5565)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </g>
        </svg>
      </div>
    </div>
...
function Button3() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[149.81px] p-px rounded-[10px] size-[36px] top-[2px]" data-name="Button">
...
function Container1() {
  return (
    <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[32px] top-[16px] w-[1615px]" data-name="Container">
      <Container2 />
      <Container6 />
    </div>
  );
...
function PageLayout() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex flex-col h-[904px] items-start relative shrink-0 w-full" data-name="PageLayout">
      <PageHeader />
      <Container7 />
      <PromotionsTablePage />
    </div>

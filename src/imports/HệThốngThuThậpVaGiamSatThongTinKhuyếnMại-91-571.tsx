import svgPaths from "./svg-ux7c4j797s";
...
function Heading() {
  return (
    <div className="absolute h-[84px] left-0 top-[44px] w-[621px]" data-name="Heading 1">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[42px] left-0 text-[#1a1a1a] text-[28px] top-0 tracking-[-0.7px] w-[608px] whitespace-pre-wrap">Kiểm soát hành vi vi phạm trên TMĐT / nền tảng số</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="h-[162.5px] relative shrink-0 w-[621px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Button />
        <Heading />
        <Paragraph />
...
function PrimitiveButton() {
  return (
    <div className="bg-white h-[36px] relative rounded-[10px] shrink-0 w-[92.391px]" data-name="Primitive.button">
...
function Container1() {
  return (
    <div className="content-stretch flex h-[162.5px] items-end justify-between relative shrink-0 w-full" data-name="Container">
      <Container2 />
      <Container3 />
    </div>
  );
...
function Container() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[212.5px] items-start left-0 pb-px pt-[24px] px-[45px] top-0 w-[1613px]" data-name="Container">
...
function Container4() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[152px] items-start left-0 pb-px pt-[32px] px-[38.5px] top-[212.5px] w-[1613px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b border-solid inset-0 pointer-events-none" />
      <Container5 />
    </div>
  );
...
function Container14() {
  return (
    <div className="absolute h-[464.5px] left-[38.5px] top-[396.5px] w-[1536px]" data-name="Container">
      <Container15 />
      <Container18 />
    </div>
  );
...
function Container38() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[335.5px] items-start left-[38.5px] p-px rounded-[4px] top-[893px] w-[1536px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Container39 />
      <Container40 />
    </div>
...
function Container64() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[234.5px] items-start left-[6.5px] px-[32px] top-[1252.5px] w-[1600px]" data-name="Container">
      <Heading5 />
      <Container65 />
    </div>
  );
...
function PY() {
  return (
    <div className="bg-[#fafafa] h-[1487px] relative shrink-0 w-full" data-name="pY">
      <Container />
      <Container4 />
      <Container14 />
      <Container38 />

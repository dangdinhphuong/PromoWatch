...
function Button8() {
  return (
    <div className="absolute bg-[#155dfc] content-stretch flex flex-col items-start left-[315.23px] pt-[11.997px] px-[11.997px] rounded-[38977000px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] size-[43.978px] top-[15.99px]" data-name="Button">
      <Icon6 />
    </div>
  );
}

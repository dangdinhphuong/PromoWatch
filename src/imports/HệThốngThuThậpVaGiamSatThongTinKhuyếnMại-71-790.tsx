import svgPaths from "./svg-nbialja6tq";
...
function HeaderCell4() {
  return (
    <div className="absolute content-stretch flex h-[44.5px] items-start left-[1017.97px] p-[12px] top-0 w-[150px]" data-name="Header Cell">
...
function HeaderCell5() {
  return (
    <div className="absolute content-stretch flex h-[44.5px] items-start left-[1167.97px] p-[12px] top-0 w-[3479.266px]" data-name="Header Cell">
...
function HeaderCell6() {
  return (
    <div className="absolute content-stretch flex h-[44.5px] items-start left-[4647.23px] p-[12px] top-0 w-[159.813px]" data-name="Header Cell">
...
function HeaderCell7() {
  return (
    <div className="absolute content-stretch flex h-[44.5px] items-start left-[4807.05px] p-[12px] top-0 w-[128.953px]" data-name="Header Cell">
...
function HeaderCell8() {
  return (
    <div className="absolute content-stretch flex h-[44.5px] items-start left-[4936px] p-[12px] top-0 w-[135.984px]" data-name="Header Cell">
...
function HeaderCell9() {
  return (
    <div className="absolute h-[44.5px] left-[5071.98px] top-0 w-[174.547px]" data-name="Header Cell">
...
function HeaderCell10() {
  return (
    <div className="absolute content-stretch flex h-[44.5px] items-start left-[5246.53px] p-[12px] top-0 w-[97.578px]" data-name="Header Cell">
...
function TableRow() {
  return (
    <div className="absolute bg-[#eff6ff] border-[rgba(0,0,0,0.1)] border-b border-solid h-[44.5px] left-0 top-0 w-[5344.109px]" data-name="Table Row">
      <HeaderCell />
      <HeaderCell1 />
      <HeaderCell2 />
      <HeaderCell3 />
...
function TableHeader() {
  return (
    <div className="absolute h-[44.5px] left-0 top-0 w-[5344.109px]" data-name="Table Header">
      <TableRow />
    </div>
  );
}
...
function Container9() {
  return (
    <div className="absolute content-stretch flex flex-col h-[40px] items-start left-[12px] top-[12.5px] w-[126px]" data-name="Container">
      <Container10 />
      <Container11 />
    </div>
  );
...
function TableCell4() {
  return (
    <div className="absolute h-[65px] left-[1017.97px] top-0 w-[150px]" data-name="Table Cell">
      <Container9 />
    </div>
  );
}
...
function TableCell5() {
  return (
    <div className="absolute h-[65px] left-[1167.97px] top-0 w-[3479.266px]" data-name="Table Cell">
      <Text />
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="absolute h-[65px] left-[4647.23px] top-0 w-[159.813px]" data-name="Table Cell">
      <Text1 />
    </div>
  );
}
...
function TableCell7() {
  return (
    <div className="absolute h-[65px] left-[4807.05px] top-0 w-[128.953px]" data-name="Table Cell">
      <Text2 />
    </div>
  );
}
...
function TableCell8() {
  return (
    <div className="absolute h-[65px] left-[4936px] top-0 w-[135.984px]" data-name="Table Cell">
      <Text3 />
    </div>
  );
}
...
function TableCell9() {
  return (
    <div className="absolute h-[65px] left-[5071.98px] top-0 w-[174.547px]" data-name="Table Cell">
      <Text4 />
    </div>
  );
}
...
function TableCell10() {
  return (
    <div className="absolute h-[65px] left-[5246.53px] top-0 w-[97.578px]" data-name="Table Cell">
      <Button4 />
    </div>
  );
}
...
function TableRow1() {
  return (
    <div className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid h-[65px] left-0 top-0 w-[5344.109px]" data-name="Table Row">
      <TableCell />
      <TableCell1 />
      <TableCell2 />
      <TableCell3 />
...
function TableRow2() {
  return (
    <div className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid h-[65px] left-0 top-[65px] w-[5344.109px]" data-name="Table Row">
      <TableCell11 />
      <TableCell12 />
      <TableCell13 />
      <TableCell14 />
...
function TableRow3() {
  return (
    <div className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid h-[65px] left-0 top-[130px] w-[5344.109px]" data-name="Table Row">
      <TableCell22 />
      <TableCell23 />
      <TableCell24 />
      <TableCell25 />
...
function Text15() {
  return (
    <div className="absolute content-stretch flex h-[19px] items-start left-[12px] top-[22.5px] w-[3455.266px]" data-name="Text">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#1e2939] text-[14px]">Thành phố Cần Thơ;Thành phố Huế;Tỉnh An Giang;Tỉnh Cao Bằng;Tỉnh Đắk Lắk;Tỉnh Điện Biên;Tỉnh Gia Lai;Tỉnh Hà Tĩnh;Tỉnh Hưng Yên;Tỉnh Khánh Hòa;Tỉnh Lạng Sơn;Tỉnh Lâm Đồng;Tỉnh Nghệ An;Tỉnh Ninh Bình;Tỉnh Phú Thọ;Tỉnh Quảng Ngãi;Tỉnh Quảng Ninh;Tỉnh Quảng Trị;Tỉnh Thái Nguyên;Tỉnh Vĩnh Long;Thành phố Hà Nội;Thành phố Hải Phòng;Thành phố Hồ Chí Minh;Tỉnh Thanh Hóa;Tỉnh Bắc Ninh;Tỉnh Cà Mau;Tỉnh Đồng Nai;Tỉnh Đồng Tháp;Tỉnh Lai Châu;Tỉnh Lào Cai;Tỉnh Sơn La;Tỉnh Tây Ninh;Tỉnh Tuyên Quang;Thành phố Đà Nẵng.</p>
    </div>
  );
}
...
function TableRow4() {
  return (
    <div className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid h-[65px] left-0 top-[195px] w-[5344.109px]" data-name="Table Row">
      <TableCell33 />
      <TableCell34 />
      <TableCell35 />
      <TableCell36 />
...
function TableCell48() {
  return (
    <div className="absolute h-[64.5px] left-[1017.97px] top-0 w-[150px]" data-name="Table Cell">
      <Container21 />
    </div>
  );
}
...
function TableCell49() {
  return (
    <div className="absolute h-[64.5px] left-[1167.97px] top-0 w-[3479.266px]" data-name="Table Cell">
      <Text20 />
    </div>
  );
}
...
function TableCell50() {
  return (
    <div className="absolute h-[64.5px] left-[4647.23px] top-0 w-[159.813px]" data-name="Table Cell">
      <Text21 />
    </div>
  );
}
...
function TableCell51() {
  return (
    <div className="absolute h-[64.5px] left-[4807.05px] top-0 w-[128.953px]" data-name="Table Cell">
      <Text22 />
    </div>
  );
}
...
function TableCell52() {
  return (
    <div className="absolute h-[64.5px] left-[4936px] top-0 w-[135.984px]" data-name="Table Cell">
      <Text23 />
    </div>
  );
}
...
function TableCell53() {
  return (
    <div className="absolute h-[64.5px] left-[5071.98px] top-0 w-[174.547px]" data-name="Table Cell">
      <Text24 />
    </div>
  );
}
...
function TableCell54() {
  return (
    <div className="absolute h-[64.5px] left-[5246.53px] top-0 w-[97.578px]" data-name="Table Cell">
      <Button8 />
    </div>
  );
}
...
function TableRow5() {
  return (
    <div className="absolute h-[64.5px] left-0 top-[260px] w-[5344.109px]" data-name="Table Row">
      <TableCell44 />
      <TableCell45 />
      <TableCell46 />
      <TableCell47 />
...
function TableBody() {
  return (
    <div className="absolute h-[324.5px] left-0 top-[44.5px] w-[5344.109px]" data-name="Table Body">
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
      <TableRow4 />
...
function Container8() {
  return (
    <div className="content-stretch flex flex-col h-[384px] items-start overflow-clip pl-[-434px] pr-[-3296.109px] relative shrink-0 w-full" data-name="Container">
      <Table />
    </div>
  );
}
...
function PY() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex flex-col h-[904px] items-start left-0 top-0 w-[1664px]" data-name="pY">
      <Container />
      <Container2 />
    </div>
  );
...
function Header() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[65px] items-start left-0 pb-px px-[32px] top-0 w-[1664px]" data-name="Header">

import svgPaths from "./svg-yd8p3pnicl";
...
function Container1() {
  return (
    <div className="absolute content-stretch flex h-[40px] items-center justify-between left-[32px] top-[16px] w-[1422px]" data-name="Container">
      <Container2 />
      <Container6 />
    </div>
  );
...
function TableHead2() {
  return (
    <div className="absolute h-[40px] left-[90px] top-0 w-[307.188px]" data-name="TableHead">
...
function TableHead3() {
  return (
    <div className="absolute h-[40px] left-[397.19px] top-0 w-[226.344px]" data-name="TableHead">
...
function TableHead4() {
  return (
    <div className="absolute h-[40px] left-[623.53px] top-0 w-[150.125px]" data-name="TableHead">
...
function TableHead5() {
  return (
    <div className="absolute h-[40px] left-[773.66px] top-0 w-[138.578px]" data-name="TableHead">
...
function TableHead6() {
  return (
    <div className="absolute h-[40px] left-[912.23px] top-0 w-[150.125px]" data-name="TableHead">
...
function TableHead7() {
  return (
    <div className="absolute h-[40px] left-[1062.36px] top-0 w-[127.031px]" data-name="TableHead">
...
function TableHead8() {
  return (
    <div className="absolute h-[40px] left-[1189.39px] top-0 w-[166.172px]" data-name="TableHead">
...
function TableHead9() {
  return (
    <div className="absolute h-[40px] left-[1355.56px] top-0 w-[80.438px]" data-name="TableHead">
...
function TableRow() {
  return (
    <div className="absolute bg-[#eff6ff] border-[rgba(0,0,0,0.1)] border-b border-solid h-[40px] left-0 top-0 w-[1436px]" data-name="TableRow">
      <TableHead />
      <TableHead1 />
      <TableHead2 />
      <TableHead3 />
...
function TableHeader() {
  return (
    <div className="absolute h-[40px] left-0 top-0 w-[1436px]" data-name="TableHeader">
      <TableRow />
    </div>
  );
}
...
function TableCell2() {
  return (
    <div className="absolute h-[49px] left-[90px] top-0 w-[307.188px]" data-name="TableCell">
      <PromotionTable1 />
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="absolute h-[49px] left-[397.19px] top-0 w-[226.344px]" data-name="TableCell">
      <PromotionTable2 />
    </div>
  );
}
...
function PromotionTable3() {
  return (
    <div className="absolute content-stretch flex flex-col h-[32px] items-start left-[8px] top-[8.5px] w-[134.125px]" data-name="PromotionTable">
      <Container14 />
      <Container15 />
    </div>
  );
...
function TableCell4() {
  return (
    <div className="absolute h-[49px] left-[623.53px] top-0 w-[150.125px]" data-name="TableCell">
      <PromotionTable3 />
    </div>
  );
}
...
function PromotionTable4() {
  return (
    <div className="absolute content-stretch flex h-[16px] items-start left-[8px] overflow-clip top-[16.5px] w-[122.578px]" data-name="PromotionTable">
...
function TableCell5() {
  return (
    <div className="absolute h-[49px] left-[773.66px] top-0 w-[138.578px]" data-name="TableCell">
      <PromotionTable4 />
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="absolute h-[49px] left-[912.23px] top-0 w-[150.125px]" data-name="TableCell">
      <PromotionTable5 />
    </div>
  );
}
...
function TableCell7() {
  return (
    <div className="absolute h-[49px] left-[1062.36px] top-0 w-[127.031px]" data-name="TableCell">
      <Badge />
    </div>
  );
}
...
function TableCell8() {
  return (
    <div className="absolute h-[49px] left-[1189.39px] top-0 w-[166.172px]" data-name="TableCell">
      <PromotionTable6 />
    </div>
  );
}
...
function TableCell9() {
  return (
    <div className="absolute h-[49px] left-[1355.56px] top-0 w-[80.438px]" data-name="TableCell">
      <Button7 />
    </div>
  );
}
...
function TableRow1() {
  return (
    <div className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid h-[49px] left-0 top-0 w-[1436px]" data-name="TableRow">
      <TableCell />
      <TableCell1 />
      <TableCell2 />
      <TableCell3 />
...
function PromotionTable11() {
  return (
    <div className="absolute content-stretch flex h-[16px] items-start left-[8px] overflow-clip top-[16.5px] w-[134.125px]" data-name="PromotionTable">
...
function TableRow2() {
  return (
    <div className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid h-[49px] left-0 top-[49px] w-[1436px]" data-name="TableRow">
      <TableCell10 />
      <TableCell11 />
      <TableCell12 />
      <TableCell13 />
...
function TableRow3() {
  return (
    <div className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid h-[49px] left-0 top-[98px] w-[1436px]" data-name="TableRow">
      <TableCell20 />
      <TableCell21 />
      <TableCell22 />
      <TableCell23 />
...
function TableRow4() {
  return (
    <div className="absolute border-[rgba(0,0,0,0.1)] border-b border-solid h-[49px] left-0 top-[147px] w-[1436px]" data-name="TableRow">
      <TableCell30 />
      <TableCell31 />
      <TableCell32 />
      <TableCell33 />
...
function TableCell42() {
  return (
    <div className="absolute h-[48.5px] left-[90px] top-0 w-[307.188px]" data-name="TableCell">
      <PromotionTable25 />
    </div>
  );
}
...
function TableCell43() {
  return (
    <div className="absolute h-[48.5px] left-[397.19px] top-0 w-[226.344px]" data-name="TableCell">
      <PromotionTable26 />
    </div>
  );
}
...
function TableCell44() {
  return (
    <div className="absolute h-[48.5px] left-[623.53px] top-0 w-[150.125px]" data-name="TableCell">
      <PromotionTable27 />
    </div>
  );
}
...
function TableCell45() {
  return (
    <div className="absolute h-[48.5px] left-[773.66px] top-0 w-[138.578px]" data-name="TableCell">
      <PromotionTable28 />
    </div>
  );
}
...
function TableCell46() {
  return (
    <div className="absolute h-[48.5px] left-[912.23px] top-0 w-[150.125px]" data-name="TableCell">
      <PromotionTable29 />
    </div>
  );
}
...
function TableCell47() {
  return (
    <div className="absolute h-[48.5px] left-[1062.36px] top-0 w-[127.031px]" data-name="TableCell">
      <Badge4 />
    </div>
  );
}
...
function TableCell48() {
  return (
    <div className="absolute h-[48.5px] left-[1189.39px] top-0 w-[166.172px]" data-name="TableCell">
      <PromotionTable30 />
    </div>
  );
}
...
function TableCell49() {
  return (
    <div className="absolute h-[48.5px] left-[1355.56px] top-0 w-[80.438px]" data-name="TableCell">
      <Button11 />
    </div>
  );
}
...
function TableRow5() {
  return (
    <div className="absolute h-[48.5px] left-0 top-[196px] w-[1436px]" data-name="TableRow">
      <TableCell40 />
      <TableCell41 />
      <TableCell42 />
      <TableCell43 />
...
function TableBody() {
  return (
    <div className="absolute h-[244.5px] left-0 top-[40px] w-[1436px]" data-name="TableBody">
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
      <TableRow4 />
...
function Container25() {
  return (
    <div className="h-[40px] relative shrink-0 w-[198.609px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Pagination() {
  return (
    <div className="h-[36px] relative shrink-0 w-[1205.391px]" data-name="Pagination">
...
function PromotionsTablePage() {
  return (
    <div className="h-[482.5px] relative shrink-0 w-full" data-name="PromotionsTablePage">
...
function PageLayout() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex flex-col h-[862px] items-start relative shrink-0 w-full" data-name="PageLayout">
      <PageHeader />
      <Container9 />
      <PromotionsTablePage />
    </div>

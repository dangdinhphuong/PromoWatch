import svgPaths from "./svg-lds61pnu9y";
...
function Heading1() {
  return (
    <div className="h-[36px] relative shrink-0 w-full" data-name="Heading 1">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[36px] left-0 text-[#101828] text-[30px] top-[-3px] tracking-[-0.75px]">Chuẩn hóa Dữ liệu Excel</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-white h-[42px] relative rounded-[14px] shrink-0 w-[134.906px]" data-name="Button">
...
function Container8() {
  return (
    <div className="h-[42px] relative shrink-0 w-[299.922px]" data-name="Container">
...
function Button2() {
  return (
    <div className="absolute bg-white border border-[#d1d5dc] border-solid h-[42px] left-[1171.73px] rounded-[14px] top-0 w-[97.266px]" data-name="Button">
      <Icon2 />
...
function TextInput() {
  return (
    <div className="absolute h-[42px] left-0 rounded-[14px] top-0 w-[1159.734px]" data-name="Text Input">
...
function Container10() {
  return (
    <div className="absolute h-[42px] left-0 top-0 w-[1159.734px]" data-name="Container">
      <TextInput />
      <Icon3 />
    </div>
  );
...
function HeaderCell() {
  return (
    <div className="absolute h-[60.5px] left-0 top-0 w-[236.594px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[16px] left-[24px] text-[#4a5565] text-[12px] top-[21px] tracking-[0.6px] uppercase">Tên</p>
    </div>
  );
}
...
function HeaderCell1() {
  return (
    <div className="absolute h-[60.5px] left-[236.59px] top-0 w-[182.969px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[16px] left-[24px] text-[#4a5565] text-[12px] top-[21px] tracking-[0.6px] uppercase">Loại Dữ liệu</p>
    </div>
  );
}
...
function HeaderCell2() {
  return (
    <div className="absolute h-[60.5px] left-[419.56px] top-0 w-[161.531px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[16px] left-[24px] text-[#4a5565] text-[12px] top-[13px] tracking-[0.6px] uppercase w-[109px] whitespace-pre-wrap">Phiên bản Đang dùng</p>
    </div>
  );
}
...
function HeaderCell3() {
  return (
    <div className="absolute h-[60.5px] left-[581.09px] top-0 w-[119.578px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[16px] left-[24px] text-[#4a5565] text-[12px] top-[13px] tracking-[0.6px] uppercase w-[59px] whitespace-pre-wrap">Số Phiên bản</p>
    </div>
  );
}
...
function HeaderCell4() {
  return (
    <div className="absolute h-[60.5px] left-[700.67px] top-0 w-[123.906px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[16px] left-[24px] text-[#4a5565] text-[12px] top-[13px] tracking-[0.6px] uppercase w-[63px] whitespace-pre-wrap">Lần Chạy Cuối</p>
    </div>
  );
}
...
function HeaderCell5() {
  return (
    <div className="absolute h-[60.5px] left-[824.58px] top-0 w-[123.469px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[16px] left-[24px] text-[#4a5565] text-[12px] top-[13px] tracking-[0.6px] uppercase w-[64px] whitespace-pre-wrap">Cập nhật Bởi</p>
    </div>
  );
}
...
function HeaderCell6() {
  return (
    <div className="absolute h-[60.5px] left-[948.05px] top-0 w-[118.891px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[16px] left-[24px] text-[#4a5565] text-[12px] top-[13px] tracking-[0.6px] uppercase w-[43px] whitespace-pre-wrap">Trạng thái</p>
    </div>
  );
}
...
function HeaderCell7() {
  return (
    <div className="absolute h-[60.5px] left-[1066.94px] top-0 w-[200.063px]" data-name="Header Cell">
      <p className="-translate-x-full absolute font-['Arimo:Bold',sans-serif] font-bold leading-[16px] left-[176.25px] text-[#4a5565] text-[12px] text-right top-[21px] tracking-[0.6px] uppercase">Thao tác</p>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="h-[32px] relative rounded-[10px] shrink-0 w-[29.484px]" data-name="Container" style={{ backgroundImage: "linear-gradient(132.657deg, rgb(239, 246, 255) 0%, rgb(238, 242, 255) 100%)" }}>
...
function Text1() {
  return (
    <div className="flex-[1_0_0] h-[40px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#101828] text-[14px] top-[-2px] w-[120px] whitespace-pre-wrap">Chuẩn hóa Giá Sản phẩm</p>
      </div>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[40px] items-center left-[24px] top-[20.5px] w-[188.594px]" data-name="Container">
      <Container13 />
      <Text1 />
    </div>
  );
...
function TableCell() {
  return (
    <div className="absolute h-[81px] left-0 top-0 w-[236.594px]" data-name="Table Cell">
      <Container12 />
    </div>
  );
}
...
function TableCell1() {
  return (
    <div className="absolute h-[81px] left-[236.59px] top-0 w-[182.969px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[24px] text-[#4a5565] text-[14px] top-[16.5px] w-[123px] whitespace-pre-wrap">Dữ liệu Thương mại Điện tử</p>
    </div>
  );
}
...
function TableCell2() {
  return (
    <div className="absolute h-[81px] left-[419.56px] top-0 w-[161.531px]" data-name="Table Cell">
      <Text2 />
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="absolute h-[81px] left-[581.09px] top-0 w-[119.578px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[24px] text-[#4a5565] text-[14px] top-[16.5px] w-[47px] whitespace-pre-wrap">5 phiên bản</p>
    </div>
  );
}
...
function TableCell4() {
  return (
    <div className="absolute h-[81px] left-[700.67px] top-0 w-[123.906px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[24px] text-[#4a5565] text-[14px] top-[28.5px]">2 giờ trước</p>
    </div>
  );
}
...
function TableCell5() {
  return (
    <div className="absolute h-[81px] left-[824.58px] top-0 w-[123.469px]" data-name="Table Cell">
...
function Text3() {
  return (
    <div className="absolute bg-[#ecfdf5] border border-[#a4f4cf] border-solid h-[42px] left-[24px] rounded-[10px] top-[19.5px] w-[70.891px]" data-name="Text">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[16px] left-[10px] text-[#007a55] text-[12px] top-[3px] w-[29px] whitespace-pre-wrap">Hoạt động</p>
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="absolute h-[81px] left-[948.05px] top-0 w-[118.891px]" data-name="Table Cell">
      <Text3 />
    </div>
  );
}
...
function Container14() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[32px] items-center justify-end left-[24px] top-[24.5px] w-[152.063px]" data-name="Container">
      <Button3 />
      <Button4 />
      <Button5 />
      <Button6 />
...
function TableCell7() {
  return (
    <div className="absolute h-[81px] left-[1066.94px] top-0 w-[200.063px]" data-name="Table Cell">
      <Container14 />
    </div>
  );
}
...
function Container16() {
  return (
    <div className="h-[32px] relative rounded-[10px] shrink-0 w-[25.859px]" data-name="Container" style={{ backgroundImage: "linear-gradient(128.942deg, rgb(239, 246, 255) 0%, rgb(238, 242, 255) 100%)" }}>
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pr-[0.016px] relative size-full">
        <Icon9 />
      </div>
    </div>
...
function Text4() {
  return (
    <div className="flex-[1_0_0] h-[40px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#101828] text-[14px] top-[-2px] w-[108px] whitespace-pre-wrap">Làm sạch Dữ liệu Khuyến mãi</p>
      </div>
    </div>
  );
}
...
function TableCell9() {
  return (
    <div className="absolute h-[81px] left-[236.59px] top-0 w-[182.969px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[24px] text-[#4a5565] text-[14px] top-[28.5px]">Dữ liệu Marketing</p>
    </div>
  );
}
...
function TableCell11() {
  return (
    <div className="absolute h-[81px] left-[581.09px] top-0 w-[119.578px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[24px] text-[#4a5565] text-[14px] top-[16.5px] w-[47px] whitespace-pre-wrap">3 phiên bản</p>
    </div>
  );
}
...
function TableCell12() {
  return (
    <div className="absolute h-[81px] left-[700.67px] top-0 w-[123.906px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[24px] text-[#4a5565] text-[14px] top-[16.5px] w-[42px] whitespace-pre-wrap">1 ngày trước</p>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="h-[32px] relative rounded-[10px] shrink-0 w-[25.047px]" data-name="Container" style={{ backgroundImage: "linear-gradient(128.051deg, rgb(239, 246, 255) 0%, rgb(238, 242, 255) 100%)" }}>
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pr-[0.016px] relative size-full">
        <Icon14 />
      </div>
    </div>
...
function Text7() {
  return (
    <div className="flex-[1_0_0] h-[40px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#101828] text-[14px] top-[-2px] w-[116px] whitespace-pre-wrap">Chuẩn hóa Địa chỉ Khách hàng</p>
      </div>
    </div>
  );
}
...
function TableCell16() {
  return (
    <div className="absolute h-[80.5px] left-0 top-0 w-[236.594px]" data-name="Table Cell">
      <Container18 />
    </div>
  );
}
...
function TableCell17() {
  return (
    <div className="absolute h-[80.5px] left-[236.59px] top-0 w-[182.969px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[24px] text-[#4a5565] text-[14px] top-[28.5px]">Dữ liệu Khách hàng</p>
    </div>
  );
}
...
function TableCell18() {
  return (
    <div className="absolute h-[80.5px] left-[419.56px] top-0 w-[161.531px]" data-name="Table Cell">
      <Text8 />
    </div>
  );
}
...
function TableCell19() {
  return (
    <div className="absolute h-[80.5px] left-[581.09px] top-0 w-[119.578px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[24px] text-[#4a5565] text-[14px] top-[16.5px] w-[47px] whitespace-pre-wrap">1 phiên bản</p>
    </div>
  );
}
...
function TableCell20() {
  return (
    <div className="absolute h-[80.5px] left-[700.67px] top-0 w-[123.906px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[24px] text-[#4a5565] text-[14px] top-[28.5px]">Chưa chạy</p>
    </div>
  );
}
...
function TableCell21() {
  return (
    <div className="absolute h-[80.5px] left-[824.58px] top-0 w-[123.469px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[24px] text-[#4a5565] text-[14px] top-[28.5px]">Lê Văn C</p>
    </div>
  );
}
...
function Text9() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex h-[26px] items-center left-[24px] px-[11px] py-[5px] rounded-[10px] top-[27.5px] w-[51.688px]" data-name="Text">
...
function TableCell22() {
  return (
    <div className="absolute h-[80.5px] left-[948.05px] top-0 w-[118.891px]" data-name="Table Cell">
      <Text9 />
    </div>
  );
}
...
function TableCell23() {
  return (
    <div className="absolute h-[80.5px] left-[1066.94px] top-0 w-[200.063px]" data-name="Table Cell">
      <Container20 />
    </div>
  );
}
...
function TableRow3() {
  return (
    <div className="absolute h-[80.5px] left-0 top-[162px] w-[1267px]" data-name="Table Row">
      <TableCell16 />
      <TableCell17 />
      <TableCell18 />
      <TableCell19 />
...
function TableBody() {
  return (
    <div className="absolute h-[242.5px] left-0 top-[60.5px] w-[1267px]" data-name="Table Body">
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
    </div>
...
function Table() {
  return (
    <div className="h-[303px] overflow-clip relative shrink-0 w-full" data-name="Table">
      <TableHeader />
      <TableBody />
    </div>
  );
...
function Container11() {
  return (
    <div className="absolute bg-white h-[305px] left-[32px] rounded-[14px] top-[223px] w-[1269px]" data-name="Container">
...
function Text13() {
  return (
    <div className="h-[16px] relative shrink-0 w-[129.375px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[#6a7282] text-[12px] text-center">{`Smart Mapping & Rules`}</p>
      </div>
    </div>
  );
}

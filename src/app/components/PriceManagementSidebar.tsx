import { BarChart3, LineChart, Bell, TrendingUp, FileText, LayoutDashboard, X } from "lucide-react";
...
export function PriceManagementSidebar({ activePage, onNavigate, isOpen = true, onClose }: PriceManagementSidebarProps) {
